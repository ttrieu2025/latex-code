...
\subsection*{Frenet-Serret Formula}

Curve \hfill $\displaystyle \vb{r}(t) = x(t)\,\vb{a}_x+ y(t)\, \vb{a}_y + z(t)\,\vb{a}_z\qquad \,\,\,\,$\\[4pt]

Arc length \hfill $s=\displaystyle\int_{t_0}^t ||\vb{v}||\,\dd t \qquad \qquad\qquad\qquad\qquad\,\,\,$\\[4pt]

Velocity \hfill $\displaystyle \vb{v} = \dv{\vb{r}}{t}\qquad \qquad\qquad\qquad\qquad\qquad\quad\,\,$\\[4pt]

Unit tangent \hfill $\displaystyle \widehat{\vb{T}} = \frac{\vb{v}}{||\vb{v}||}\qquad \qquad\qquad\qquad\qquad\qquad\,\,\,$\\[4pt]

Acceleration \hfill $\displaystyle \vb{a} = \dv{\vb{v}}{t} = \dv[2]{\vb{r}}{t}\qquad \qquad\qquad\qquad\qquad\,$\\[4pt]

Binormal \hfill $\displaystyle \widehat{\vb{B}} = \frac{\vb{v}\times \vb{a}}{||\vb{v}\times\vb{a}||}\qquad \qquad\qquad\qquad\qquad\,\,\,\,$\\[4pt]

Curvature\hfill
$\displaystyle \kappa =\frac{||\vb{v}\times \vb{a}||}{||\vb{v}||^3}\qquad \qquad\qquad\qquad\qquad\,\,\,\,\,$\\[4pt]


Radius of Curvature\hfill 
$\rho = \dfrac{1}{\kappa}\qquad \qquad\qquad\qquad\qquad\qquad\quad\,\,\,\,\,$\\[4pt]

Normal \hfill $\displaystyle\widehat{\vb{N}}= \widehat{\vb{B}} \times \widehat{\vb{T}}\qquad \qquad\qquad\qquad\qquad\quad\,\,\,$\\[4pt]

Torsion \hfill $\displaystyle \tau = \dfrac{(\vb{v}\times\vb{a})\cdot(\dd \vb{a}/\dd t)}{||\vb{v}\times\vb{a}||^2}\qquad \qquad\qquad\quad\,$\\[4pt]

Frenet-Serret Formulae
 \[\displaystyle\dv{\widehat{\vb{T}}}{s} = \kappa \widehat{\vb{N}},\quad \displaystyle\dv{\widehat{\vb{N}}}{s} = -\kappa \widehat{\vb{T}}+\tau\widehat{\vb{B}},\quad\displaystyle\dv{\widehat{\vb{B}}}{s} = -\tau \widehat{\vb{N}}\]
...
Stokes's Theorem \hfill$\displaystyle \oint_{\partial S} \vb{F} \cdot \dd \vb{r} = \iint_S (\nabla \times \vb{F}) \cdot \dd\vb{S}\quad\,$
